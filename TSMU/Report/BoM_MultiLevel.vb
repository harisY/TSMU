...
Public Class BoM_MultiLevel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.BoM_MultiLevel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBoM_MultiLevel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BoM_MultiLevel = New BoM_MultiLevel()
        rpt.Site = Me.Site
        Return rpt
    End Function
