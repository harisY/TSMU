...
Public Class BoM_MaterialUsedBy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.BoM_MaterialUsedBy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBoM_MaterialUsedBy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BoM_MaterialUsedBy = New BoM_MaterialUsedBy()
        rpt.Site = Me.Site
        Return rpt
    End Function
