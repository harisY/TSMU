...
Public Class Rpt_PaymentSolomon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.Rpt_PaymentSolomon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PaymentSolomon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PaymentSolomon = New Rpt_PaymentSolomon()
        rpt.Site = Me.Site
        Return rpt
    End Function
