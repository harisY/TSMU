...
Public Class Rpt_APSignature
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.Rpt_APSignature.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_APSignature
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_APSignature = New Rpt_APSignature()
        rpt.Site = Me.Site
        Return rpt
    End Function
