...
Public Class Rpt_UploadNonIDR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.Rpt_UploadNonIDR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_UploadNonIDR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_UploadNonIDR = New Rpt_UploadNonIDR()
        rpt.Site = Me.Site
        Return rpt
    End Function
