...
Public Class Frm_Rpt_ViewPPhNew
    ...
    Private Sub GetDataNewPPh()
        ...
        dt = pay_class.DataGridViewPPhNew(date1, date2)
    ...
    Private Async Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        Try
            ...
            Await Task.Run(Sub() GetDataNewPPh())
        Catch ex As Exception
            ProgBar.Visible = False
            MsgBox(ex.Message)
            WriteToErrorLog(ex.Message, gh_Common.Username, ex.StackTrace)
    ...
    Private Sub tsBtn_newData_Click(sender As Object, e As EventArgs) Handles tsBtn_newData.Click
    ...
    Private Sub tsBtn_filter_Click(sender As Object, e As EventArgs) Handles tsBtn_filter.Click
    ...
    Private Sub ToolStripSeparator8_Click(sender As Object, e As EventArgs) Handles ToolStripSeparator8.Click

    End Sub

    Private Sub tsBtn_prev_Click(sender As Object, e As EventArgs) Handles tsBtn_prev.Click

    End Sub

    Private Sub ToolStripSeparator9_Click(sender As Object, e As EventArgs) Handles ToolStripSeparator9.Click
    ...
    Private Sub DateEdit3_EditValueChanged(sender As Object, e As EventArgs) Handles DateEdit3.EditValueChanged
