...
Public Class Frm_Filter_payment
    ...
    Sub tampildata()
        ...
        Try
            ...
            If _gridshipper2.Rows.Count > 0 Then
                ...
                _gridshipper2.Columns(1).HeaderText = "Payment Date"
                _gridshipper2.Columns(1).Width = 100
                _gridshipper2.Columns(1).DefaultCellStyle.Format = "dd-MM-yyyy"
                _gridshipper2.Columns(1).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
                _gridshipper2.Columns(1).Visible = True
                ...
                Dim rect As Rectangle = _gridshipper2.GetCellDisplayRectangle(18, -1, True)
    ...
    Private Sub checkboxHeadercek3_CheckedChanged(sender As System.Object, e As System.EventArgs)
        ...
        For Each row As DataGridViewRow In _gridshipper2.Rows
            row.Cells(18).Value = headerBox.Checked
        Next
    End Sub
    ...
    Private Sub Frm_Filter_payment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Using con As New SqlConnection(constring)
            ...
            Try
                Dim query As String
                query = "UPDATE t1 SET t1.tot_dpp = t2.dpp,t1.tot_ppn = t2.ppn,t1.pph = t2.pph,t1.total_dpp_ppn =t2.dpp+t2.ppn+t2.pph-t2.pph " &
                        "FROM Payment_Header1 as t1 " &
                        "INNER JOIN (select vrno, SUM(dpp) AS dpp,SUM(ppn) AS ppn,SUM(pph) AS pph " &
        ...
        Try
            If _gridshipper2.Rows.Count > 0 Then
                ...
                With Frm_Payment
                    ...
                    ._Tot_Voucher.Text = Format(Val(Frm_Payment._Tot_Voucher.Text), "#,#.##")
                    ._Tot_Ppn.Text = Format(Val(Frm_Payment._Tot_Ppn.Text), "#,#.##")
                    ._Tot_Dpp_Invoice.Text = Format(Val(Frm_Payment._Tot_Dpp_Invoice.Text), "#,#.##")
                    ._Tot_Pph.Text = Format(Val(Frm_Payment._Tot_Pph.Text), "#,#.##")
                    ._debit_bank.Text = Format(Val(Frm_Payment._debit_bank.Text), "#,#.##")
                    ._tot_cndn.Text = Format(Val(Frm_Payment._tot_cndn.Text), "#,#.##")
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Using con As New SqlConnection(constring)
            ...
            Try
                ...
                For i As Integer = 0 To Me._gridshipper2.Rows.Count
                    cek3 = Me._gridshipper2.Rows(i).Cells(18).Value
                    vrno = Me._gridshipper2.Rows(i).Cells(0).Value.ToString
                    query = "update payment_header1 set cek4='" & cek3 & "' where vrno='" & vrno & "' "
                    mdlmain.ExecQueryByCommand(query)
