Public Class frmForecastHargaManual
    Dim Service As New TForecastPrice_TempService
    Dim Model As TForecastPrice_TempModel
    Dim ff_Detail As FrmForecastPriceTemp

    Private Sub frmForecastHargaManual_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As Integer = 0, Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmForecastPriceTemp(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Private Sub frmForecastHargaManual_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
