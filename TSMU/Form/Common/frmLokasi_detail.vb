Public Class frmLokasi_detail
    Dim ff_Detail As frmLokasi_detail_input
    ...
    Public Overrides Sub Proc_Filter()
        FilterData.Text = "Filter Data Lokasi Detail"
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New frmLokasi_detail_input(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Public Overrides Sub Proc_DeleteData()
        ...
        End Try
    End Sub
    Private Sub frmLokasi_detail_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
