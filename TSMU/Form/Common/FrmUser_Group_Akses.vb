Public Class FrmUser_Group_Akses
    Dim ff_Detail As FrmUser_Group_Akses_detail
    Dim dtGrid As DataTable
    Dim fc_Class As New clsGroupUserAkses

    Private Sub FrmUser_Group_Akses_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmUser_Group_Akses_detail(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Private Sub FrmUser_Group_Akses_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
