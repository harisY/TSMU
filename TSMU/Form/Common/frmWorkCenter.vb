Public Class frmWorkCenter
    Dim ff_Detail As frmWorkCenter_detail
    Dim dtGrid As DataTable
    Dim fc_Class As New clsWorkCenter
    Private Sub frmWorkCenter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New frmWorkCenter_detail(ls_Code, ls_Code2, Me, li_Row, Grid)
        ...
        Try
            If e.KeyCode = Keys.F1 Then
                ...
                For Each rowHandle As Integer In selectedRows
                    If rowHandle >= 0 Then
                        ID = GridView1.GetRowCellValue(rowHandle, "ID")
                        Description = GridView1.GetRowCellValue(rowHandle, "Decription")
                    End If
                Next rowHandle
