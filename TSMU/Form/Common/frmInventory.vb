Public Class frmInventory
    Dim ff_Detail As frmInventory_detail
    ...
    Public Overrides Sub Proc_Filter()
        FilterData.Text = "Filter Data Inventory"
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New frmInventory_detail(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Public Overrides Sub Proc_DeleteData()
        Try
            fc_Class.InvtID = Trim(Grid.SelectedRows(0).Cells(0).Value)
            fc_Class.DeleteHeader()
