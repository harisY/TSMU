Public Class frmMesin
    Dim ff_Detail As frmMesin_detail
    Dim dtGrid As DataTable
    Dim fc_Class As New clsMesin
    Private Sub frmMesin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Overrides Sub Proc_Filter()
        FilterData.Text = "Filter Data Mesin"
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New frmMesin_detail(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Public Overrides Sub Proc_DeleteData()
        ...
        End Try
    End Sub
    Private Sub frmGroup_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
