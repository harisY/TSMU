Public Class FrmCustomer
    Dim ff_Detail As frmCustomer_detail
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New frmCustomer_detail(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Private Sub Grid_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grid.CellContentDoubleClick
        Try
            If Grid.SelectedRows.Count > 0 Then
                ...
                If Grid.Rows.Count > 0 Then
                    Call CallFrm(Grid.SelectedRows(0).Cells(1).Value.ToString,
    ...
    Public Overrides Sub Proc_DeleteData()
        Try
            ...
            fc_Class.Delete(Trim(Grid.SelectedRows(0).Cells(1).Value).ToString)
