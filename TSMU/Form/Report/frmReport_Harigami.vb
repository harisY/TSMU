...
Public Class frmReport_Harigami
    Dim ObjHarigami As HarigamiModels
    Dim fdtl_Config As DataTable = Nothing

    Private Sub frmReport_Harigami_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GetDataGrid()
        ...
        dt = ObjHarigami.GetReportHarigami(tgl, tgl1)
