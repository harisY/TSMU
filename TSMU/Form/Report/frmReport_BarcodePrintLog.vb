...
Public Class frmReport_BarcodePrintLog
    Dim fdtl_Config As DataTable = Nothing

    Private Sub frmReport_BarcodePrintLog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GetDataGrid()
        ...
        Dim Objadm = New ReportBarcodePrintLog
        dt = Objadm.GetDataGrid(tgl, tgl1)
