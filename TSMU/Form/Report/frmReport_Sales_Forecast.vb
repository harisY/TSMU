...
Public Class frmReport_Sales_Forecast
    Dim fc_class As New clsReport
    Dim fdtl_Config As DataTable = Nothing

    Private Sub frmReport_Sales_Forecast_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub ViewSalesForecast()
        Try
            Dim ds As New DataSet
            ds = fc_class.SF_LoadReport(cmbSite.Text.Trim, _cmbYear.Text.Trim, _txtItem.Text.Trim, _txtCustomer.Text)
            Dim laporan As New Sales_Forecast
            laporan.SetDataSource(ds.Tables("SalesForecastTable"))
    ...
    Private Sub GetDataGrid()
        Try
            ...
            Invoke(Sub()
                   ...
                   End Sub)
            Dim dt As New DataTable
            dt = fc_class.SF_LoadDataGrid(strSite, strYear, strItem, strCust)
            setDataSource(dt)
    ...
    Public Sub PrintDokumen(Optional ByVal fb_Preview As Boolean = False)
        Try
            ...
            If GridView1.RowCount > 0 Then
                crReport = fc_class.SalesForecastReport(cmbSite.Text.Trim, _cmbYear.Text.Trim, _txtItem.Text.Trim, _txtCustomer.Text)
