...
Public Class frmReport_Sales_Price
    Dim fc_class As New clsReport
    Dim fdtl_Config As DataTable = Nothing

    Private Sub frmReport_Sales_Price_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub ViewSalesPrice()
        Try
            ...
            ds = fc_class.SP_LoadReport(cmbSite.Text.Trim, _cmbYear.Text.Trim, _txtItem.Text.Trim, _txtCustomer.Text)
            Dim laporan As New Sales_Price
            laporan.SetDataSource(ds.Tables("SalesPriceTable"))
    ...
    Private Sub GetDataGrid()
        Try
            ...
            Invoke(Sub()
                   ...
                   End Sub)
            Dim dt As New DataTable
            dt = fc_class.SP_LoadDataGrid(strSite, strYear, strItem, strCust)
            setDataSource(dt)
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Public Sub PrintDokumen(Optional ByVal fb_Preview As Boolean = False)
        Try
            ...
            If GridView1.RowCount > 0 Then
                crReport = fc_class.SalesPriceReport(cmbSite.Text.Trim, _cmbYear.Text.Trim, _txtItem.Text.Trim, _txtCustomer.Text)
