...
Public Class frmReport_Sales_Order
    Dim fc_class As New clsReport
    Dim fdtl_Config As DataTable = Nothing

    Private Sub frmReport_Sales_Order_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub ViewSalesOrder()
        Try
            ...
            ds = fc_class.SO_LoadReport(cmbSite.Text.Trim, _cmbYear.Text.Trim, _txtItem.Text.Trim, _txtCustomer.Text)
            Dim laporan As New Sales_Order
            laporan.SetDataSource(ds.Tables("SalesOrderTable"))
    ...
    Public Overrides Sub Proc_Excel()
        Try
            If Grid.Rows.Count > 0 Then
                ExcelLib.ExportToExcel("D:\PROJECT\TAKAGI\Doc\", Grid, "SO_")
                'ExportToExcel()
            Else
    ...
    Private Async Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        Try
            ...
            'dt = fc_class.SO_LoadDataGrid(cmbSite.Text, _cmbYear.Text, _txtItem.Text, _txtCustomer.Text)
            'Grid.DataSource = dt
    ...
    Private Sub GetDataGrid()
        Try
            ...
            Invoke(Sub()
                   ...
                   End Sub)
            Dim dt As New DataTable
            dt = fc_class.SO_LoadDataGrid(strSite, strYear, strItem, strCust)
            setDataSource(dt)
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Public Sub PrintDokumen(Optional ByVal fb_Preview As Boolean = False)
        Try
            ...
            If Grid.Rows.Count > 0 Then
                crReport = fc_class.SalesOrderReport(cmbSite.Text.Trim, _cmbYear.Text.Trim, _txtItem.Text.Trim, _txtCustomer.Text)
