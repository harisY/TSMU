...
Imports DevExpress.XtraEditorsClsReportMatome
Imports DevExpress.XtraGrid
Imports DevExpress.XtraGrid.Views.Grid
Imports DevExpress.XtraSplashScreen

Public Class FrmReport_Matome_New
    ...
    End Sub
    Private Sub FrmReport_Matome_New_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Overrides Sub Proc_Excel()
        Try
            If AdvBandedGridView1.RowCount > 0 Then
                ...
                SaveToExcel(Grid, "Matome", "Matome", False)
