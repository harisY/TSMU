Public Class FrmSystemLogin
    ...
    Private Sub FrmSystemLogin_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub FrmSystemLogin_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        If Me.Visible Then
    ...
    Private Sub FrmSystemLogin_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub UsernameTextBox_KeyPress(sender As Object, e As KeyPressEventArgs) Handles UsernameTextBox.KeyPress, PasswordTextBox.KeyPress
