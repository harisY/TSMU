Public Class FrmHancuran
    Dim ff_Detail As FrmHancuranDetail
    Dim dtGrid As DataTable
    Dim fc_Class As New HancuranModel
    Dim ID As String

    Private Sub FrmHancuran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
