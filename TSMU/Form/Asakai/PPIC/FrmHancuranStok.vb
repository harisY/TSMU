Public Class FrmHancuranStok

    Dim ff_Detail As FrmHancuranStokDetail
    Dim dtGrid As DataTable
    Dim fc_Class As New HancuranModel
    Dim ID As String

    Private Sub FrmHancuranStok_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadGrid()
        Try
            dtGrid = fc_Class.GetDataLoad_HS()
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmHancuranStokDetail(ls_Code, Me, li_Row, GridControl)
    ...
    Private Sub GridControl_DoubleClick(sender As Object, e As EventArgs) Handles GridControl.DoubleClick
        ...
        Try
            ...
            For Each rowHandle As Integer In selectedRows
                If rowHandle >= 0 Then
                    fc_Class.H_IDTransaksi = GridView1.GetRowCellValue(rowHandle, "ID")
                    ID = GridView1.GetRowCellValue(rowHandle, "ID")
                End If
            Next rowHandle
