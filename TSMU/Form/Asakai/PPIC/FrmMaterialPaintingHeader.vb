Public Class FrmMaterialPaintingHeader

    Dim ff_Detail As FrmMaterialPainting
    Dim dtGrid As DataTable
    Dim fc_Class As New PemakaianPaintingModel


    Private Sub FrmMaterialPaintingHeader_Load(sender As Object, e As EventArgs) Handles MyBase.Load
