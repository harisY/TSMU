Public Class FrmKebijakan
    Dim ff_Detail As FrmKebijakaDetail
    Dim dtGrid As DataTable
    Dim fc_Class As New KebijakanModel
    ...
    Private Sub FrmKebijakan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmKebijakaDetail(ls_Code, Me, li_Row, GridControl)
    ...
    Private Sub GridControl_DoubleClick(sender As Object, e As EventArgs) Handles GridControl.DoubleClick
        Try
            ...
            fc_Class = New KebijakanModel
            Dim selectedRows() As Integer = GridView1.GetSelectedRows()
            For Each rowHandle As Integer In selectedRows
                If rowHandle >= 0 Then
                    fc_Class.ID = GridView1.GetRowCellValue(rowHandle, "ID")
                    fc_Class.Kebijakan = GridView1.GetRowCellValue(rowHandle, "Kebijakan")
    ...
    Public Overrides Sub Proc_DeleteData()
        ...
        Try
            Dim selectedRows() As Integer = GridView1.GetSelectedRows()
            ObjAbsenDetail = New KebijakanDetailModel
            For Each rowHandle As Integer In selectedRows
                If rowHandle >= 0 Then
                    ID = GridView1.GetRowCellValue(rowHandle, "ID")
                End If
