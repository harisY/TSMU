...
Public Class FrmQualityProblem
    Dim ff_Detail As FrmQualityProblemDetail
    Dim dtGrid As DataTable
    Dim fc_Class As New QualityProblemModel
    Dim IdTrans As String
    Dim Tanggal As Date
    Private Sub FrmQualityProblem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal ls_Code3 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmQualityProblemDetail(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Private Sub Grid_DoubleClick(sender As Object, e As EventArgs) Handles Grid.DoubleClick
        Try
            ...
            fc_Class = New QualityProblemModel
            Dim selectedRows() As Integer = GridView1.GetSelectedRows()
            For Each rowHandle As Integer In selectedRows
                If rowHandle >= 0 Then
                    IdTrans = GridView1.GetRowCellValue(rowHandle, "IDTransaksi")
