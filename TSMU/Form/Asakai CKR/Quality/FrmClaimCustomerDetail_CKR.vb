...
Public Class FrmClaimCustomerDetail_CKR
    ...
    Dim ObjClaimCustomerDetail As New ClaimCustomerDetailModel_CKR
    ...
    Public Sub New(ByVal strCode As String,
        ...
        Tag = _Tag
    End Sub
    Private Sub FrmClaimCustomerDetail_CKR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If isUpdate = False Then
                ...
                For i As Integer = 0 To GridView1.RowCount - 1
                    ...
                    ObjClaimCustomerDetail = New ClaimCustomerDetailModel_CKR
