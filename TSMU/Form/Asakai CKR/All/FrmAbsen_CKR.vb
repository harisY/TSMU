Public Class FrmAbsen_CKR

    Dim ff_Detail As FrmAbsenDetail_CKR
    Dim dtGrid As DataTable
    Dim fc_Class As New AbsenModel_CKR
    Dim ObjAbsen As New AbsenModel_CKR
    Dim ObjAbsenDetail As New AbsenModelDetail_CKR
    ...
    Private Sub FrmAbsen_CKR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmAbsenDetail_CKR(ls_Code, ls_Code2, Me, li_Row, GridControl)
    ...
    Public Overrides Sub Proc_DeleteData()
        ...
        Try
            ...
            Dim selectedRows() As Integer = GridView1.GetSelectedRows()
            ObjAbsenDetail = New AbsenModelDetail_CKR
            For Each rowHandle As Integer In selectedRows
                If rowHandle >= 0 Then
