...
Public Class FrmMaintenanceDetail_CKR
    ...
    Dim ObjMaintenanceDetail As New MaintenanceDetailModel_CKR
    Dim KodeTrans As String = ""
    Dim fc_Class As New MaintenanceModel_CKR
    Dim GridDtl As GridControl
    Dim _Tag As TagModel

    Private Sub FrmMaintenanceDetail_CKR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub getdataview1()
        Try
            ...
            If isUpdate = False Then
                ...
                fc_Class = New MaintenanceModel_CKR
                With fc_Class
    ...
    Private Sub BtnBulan_Click(sender As Object, e As EventArgs) 
