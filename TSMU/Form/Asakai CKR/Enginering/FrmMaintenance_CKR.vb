...
Public Class FrmMaintenance_CKR

    Dim ff_Detail As FrmMaintenanceDetail_CKR
    Dim dtGrid As DataTable
    Dim fc_Class As New MaintenanceModel_CKR
    Dim IdTrans As String
    Dim Tanggal As Date

    Private Sub FrmMaintenance_CKR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal ls_Code3 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FrmMaintenanceDetail_CKR(ls_Code, ls_Code2, Me, li_Row, Grid)
