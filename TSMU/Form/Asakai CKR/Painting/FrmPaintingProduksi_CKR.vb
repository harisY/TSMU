...
Public Class FrmPaintingProduksi_CKR
    ...
    Dim ff_Detail As FormPaintingProduksi_Detail_CKR
    ...
    Private Sub FrmPaintingProduksi_CKR_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Call Proc_EnableButtons(False, True, True, True, True, False, False, False)
        Call LoadGrid()
    ...
    Private Sub CallFrm(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal ls_Code3 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail IsNot Nothing AndAlso ff_Detail.Visible Then
            ...
            ff_Detail.Close()
        End If
        ff_Detail = New FormPaintingProduksi_Detail_CKR(ls_Code, ls_Code2, Me, li_Row, Grid)
