...
Public Class FrmPemakaianMaterial_CKR
    ...
    Dim fc_Class_Material_Detail As New PemakaianMaterialDetail_CKR
    ...
    Public Overrides Sub InitialSetForm()
        Try
            ...
            bs_MainFormName = "FrmMaterialUsage_CKR"
            ...
            For i As Integer = 0 To GridMaterial.RowCount - 1
                If GridMaterial.Rows(i).Cells(0).Value Is System.DBNull.Value OrElse
                   ...
                   GridMaterial.Rows(i).Cells(3).Value Is System.DBNull.Value Then
                    MessageBox.Show("Pastikan Data MAterial tidak ada yang salah")
                    Exit Sub

                End If
            Next

            For i As Integer = 0 To GridKomponen.RowCount - 1
                If GridKomponen.Rows(i).Cells(0).Value Is System.DBNull.Value OrElse
                   GridKomponen.Rows(i).Cells(2).Value Is System.DBNull.Value OrElse
                   GridKomponen.Rows(i).Cells(3).Value Is System.DBNull.Value Then
                    MessageBox.Show("Pastikan Data Komponen tidak ada yang salah")
                    Exit Sub
            ...
            If isUpdate = False Then
                ...
                For i As Integer = 0 To GridMaterial.RowCount - 1
                    If GridMaterial.Rows(i).Cells(0).ToString <> "" Then
                        fc_Class_Material_Detail = New PemakaianMaterialDetail_CKR
                ...
                For j As Integer = 0 To GridKomponen.RowCount - 1
                    If GridKomponen.Rows(j).Cells(0).ToString <> "" Then
                        fc_Class_Komponen_Detail = New PemakaianKomponenlDetail_CKR
                ...
                Using ofd As OpenFileDialog = New OpenFileDialog() With {.Filter = "Excel Files|*.xls;*.xlsx"}
                    ...
                    If ofd.ShowDialog() = DialogResult.OK Then
                        ...
                        If IO.File.Exists(FileLokasi) Then
                            ...
                            cnHeader.Open()
                            Dim cmdHeader As OleDbCommand = New OleDbCommand("SELECT F1 as IDMaterial, F2 as Description," & KolomQty & " as Quantity," & KolomHarga & " as TotalPrice FROM [Sheet2$A1:CZ100]", cn) '
