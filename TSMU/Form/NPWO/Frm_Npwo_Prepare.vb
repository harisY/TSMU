Public Class Frm_Npwo_Prepare
    ...
    Private Sub Bok_Click(sender As Object, e As EventArgs) Handles Bok.Click
        ...
        Else
            fc_Class.UpdatePrepareNPWO(ID, TPrepare.EditValue)
            Me.Close()
        End If
    ...
    Private Sub BCancel_Click(sender As Object, e As EventArgs) Handles BCancel.Click
        ...
        MessageBox.Show("Prepare is Null",
                                ...
                                MessageBoxIcon.Exclamation,
                                MessageBoxDefaultButton.Button1)
        fc_Class.UpdatePrepareNPWO(ID, "")
        Me.Close()

    End Sub

    Private Sub Frm_Npwo_Prepare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call FillCombo()
    End Sub
