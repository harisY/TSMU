...
Public Class NPP_RevInformasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.NPP_RevInformasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNPP_RevInformasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NPP_RevInformasi = New NPP_RevInformasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
