...
Public Class FrmApprovalDetail
    ...
    Public Overrides Sub Proc_Approve()
        Try
            Dim result As DialogResult = XtraMessageBox.Show("Approve Suspend " & "'" & TxtNoSuspend.Text & "'" & " ?", "Confirmation", MessageBoxButtons.YesNo)
            If result = System.Windows.Forms.DialogResult.Yes Then
                ObjSuspendHeader.UpdateData(TxtNoSuspend.Text, level)
