...
Public Class FrmSuspendSettleCC
    Dim ff_Detail As FrmSuspendSettleDetail
    Dim ff_Detail1 As FrmSuspendSettleDetailDirectCC
    Dim dtGrid As DataTable
    Dim dtGrid2 As DataTable
    Dim ObjSettle As SettleHeader
    Dim _Service As SettleHeader

    Private Sub FrmSuspendSettleCC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CallFrmDirect(Optional ByVal ls_Code As String = "", Optional ByVal ls_Code2 As String = "", Optional ByVal li_Row As Integer = 0)
        If ff_Detail1 IsNot Nothing AndAlso ff_Detail1.Visible Then
            ...
            ff_Detail1.Close()
        End If
        ff_Detail1 = New FrmSuspendSettleDetailDirectCC(ls_Code, ls_Code2, Me, li_Row, Grid)
    ...
    Private Sub FrmSuspendSettleCC_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
