...
Public Class SuspendApprovalHeaderModel
    ...
    Public Function GetDataGrid() As DataTable
        Try
            ...
            FROM suspend_header where deptid in(" & nilai & ") and State = " & QVal(level) & " Order by SuspendID"
    ...
    Public Sub UpdateHeader(ByVal _SuspendID As String, level As Integer)
        Try
            Dim ls_SP As String = " " & vbCrLf &
                                    ...
                                    "SET State = " & QVal(level) + 1 & " WHERE SuspendID = '" & _SuspendID & "'"
    ...
    Public Sub UpdateData(ByVal _SuspendID As String, level As Integer)
        Try
...
Public Class SuspendApprovalDetailModel
    ...
    Public Function GetDataDetailByID(SuspendID) As DataTable
        Try
