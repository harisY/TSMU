...
Public Class settleApproval
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.settleApproval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsettleApproval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As settleApproval = New settleApproval()
        rpt.Site = Me.Site
        Return rpt
    End Function
