...
Public Class suspendreport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.suspendreport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tgld() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tgls() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedsuspendreport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As suspendreport1 = New suspendreport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
