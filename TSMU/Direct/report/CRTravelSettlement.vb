...
Public Class CRTravelSettlement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.CRTravelSettlement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTravelSettlement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTravelSettlement = New CRTravelSettlement()
        rpt.Site = Me.Site
        Return rpt
    End Function
