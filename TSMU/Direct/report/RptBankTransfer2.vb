...
Public Class RptBankTransfer2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.RptBankTransfer2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBankTransfer2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBankTransfer2 = New RptBankTransfer2()
        rpt.Site = Me.Site
        Return rpt
    End Function
