...
Public Class CRCCSettlement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.CRCCSettlement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCCSettlement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCCSettlement = New CRCCSettlement()
        rpt.Site = Me.Site
        Return rpt
    End Function
