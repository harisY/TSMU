...
Public Class RptBankTransfer3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.RptBankTransfer3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBankTransfer3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBankTransfer3 = New RptBankTransfer3()
        rpt.Site = Me.Site
        Return rpt
    End Function
