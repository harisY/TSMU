...
Public Class SettleEntertain1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.SettleEntertain.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSettleEntertain1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SettleEntertain = New SettleEntertain()
        rpt.Site = Me.Site
        Return rpt
    End Function
