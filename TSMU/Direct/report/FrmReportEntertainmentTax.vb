...
Public Class FrmReportEntertainmentTax
    Dim ent_class As New Cls_report
    Dim ent_Config As DataTable = Nothing

    Private Sub FrmReportEntertainmentTax_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GetDataGridEntAdvance()
        Dim date1 As String = ""
        Dim date2 As String = ""
        ...
        dt = ent_class.DataGridViewReportEntertainmentTaxAdvance(date1, date2)
    ...
    Private Sub GetDataGridEntSettle()
        Dim datesup1 As String = ""
        Dim datesup2 As String = ""
        ''Dim suppliername As String = ""

        Invoke(Sub()
                   datesup1 = DateEdit1_sup.Text
                   datesup2 = DateEdit2_sup.Text
               End Sub)
        Dim dt As New DataTable
        dt = ent_class.DataGridViewReportEntertainmentTaxSettle(datesup1, datesup2)
    ...
    Private Async Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        Try
            ...
            Await Task.Run(Sub() GetDataGridEntAdvance())
        Catch ex As Exception
            ProgBar.Visible = False
            MsgBox(ex.Message)
            WriteToErrorLog(ex.Message, gh_Common.Username, ex.StackTrace)
    ...
    Private Async Sub btnLoad_sup_Click(sender As Object, e As EventArgs) Handles btnLoad_sup.Click
        Try
            ...
            Await Task.Run(Sub() GetDataGridEntSettle())
        Catch ex As Exception
            Progbar_sup.Visible = False
            MsgBox(ex.Message)
            WriteToErrorLog(ex.Message, gh_Common.Username, ex.StackTrace)
