...
Public Class CRCCAccruedAndSettle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRCCAccruedAndSettle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.CRCCAccruedAndSettle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCCAccruedAndSettle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCCAccruedAndSettle = New CRCCAccruedAndSettle()
        rpt.Site = Me.Site
        Return rpt
    End Function
