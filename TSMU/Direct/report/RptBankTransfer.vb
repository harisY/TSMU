...
Public Class RptBankTransfer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TSMU.RptBankTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBankTransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBankTransfer = New RptBankTransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
