...
Public Class QualityProblemModel_CKR
    ...
    Public Property ObjDetailQualityProblem() As New Collection(Of QualityProblemDetailModel_CKR)
    Public Sub New()
...
Public Class QualityProblemDetailModel_CKR
