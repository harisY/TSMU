...
Public Class ClaimCustomerModel_CKR
    Dim Query As String
    ...
    Public Property ObjDetailClaimCustomer() As New Collection(Of ClaimCustomerDetailModel_CKR)
...
Public Class ClaimCustomerDetailModel_CKR
