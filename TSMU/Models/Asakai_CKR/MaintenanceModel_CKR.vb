Imports System.Collections.ObjectModel_CKR
Public Class MaintenanceModel_CKR
    Dim Query As String
    ...
    'Public Property ObjDetailMaintenance() As New Collection(Of MaintenanceDetailModel_CKR)
...
Public Class MaintenanceDetailModel_CKR
