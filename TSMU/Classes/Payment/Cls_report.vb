...
Public Class Cls_report
    ...
    Public Function getalldatabank() As DataTable
        ...
        Try
            query = "select " &
             "payment_header1.vrno vrno, " &
                 "Payment_Header1.VendorName VendorName, " &
                 "Payment_Header1.Total_DPP_PPN, " &
                 "payment_Header1.Tot_PPN Tot_PPN, " &
                 "payment_Header1.pph pph, " &
                 "Payment_Header1.Biaya_Transfer Biaya_Transfer, " &
                 "((Payment_Header1.Total_DPP_PPN + payment_header1.pph)- pph - cm_dm - Payment_Header1.Biaya_Transfer) as Total_Bayar " &
