    ...
    Private Sub InsertData(i As Integer)
        Try
            Dim Params As List(Of SqlParameter) = New List(Of SqlParameter) From {
                ...
                New SqlParameter() With {.ParameterName = "InvtId", .Value = ObjCollections(i).InvtId},
                New SqlParameter() With {.ParameterName = "PathFile", .Value = ObjCollections(i).PathFile},
                New SqlParameter() With {.ParameterName = "PathFile1", .Value = ObjCollections(i).PathFile1}
            }
